      ...
      <div className="mt-0 lg:mt-32 max-w-8xl mx-auto flex justify-center transform  pt-24 pb-2  md:pb-12 lg:pb-36 mb-1 lg:mb-12 lg:flex-row flex-col">
        <div className="transform -translate-y-3 lg:translate-x-16">
          <div className="  flex flex-col justify-end">
            <div className="font-medium text-8xl pb-3 Avenir tracking-tighter text-gray-900 flex mx-auto lg:mx-0">
              illoMX
              <span className="absolute text-base font-light text-gray-200 tracking-tight text-normal transform translate-x-60 md:translate-x-60 translate-y-20">
                beta
              </span>
            </div>
            ...
            <div className=" flex inline-flex justify-center">
              <a
                className="ml-2 inline-flex items-center px-8 py-1 mt-4 font-normal bg-gradient-to-br from-purple-600 via-blue-500 to-green-300 hover:from-indigo-600 hover:via-pink1-600 hover:to-red-600 inline-flex items-center py-3 mt-4 font-normal text-white   active:bg-blue-600 rounded-md text-md md:mt-0"
                href="/market"
              >
                <span className="w-28 flex justify-center">Launch Market</span>
              </a>
              <a
                className="ml-2 inline-flex items-center px-8 py-1 mt-4 font-normal text-white hover:bg-gray-700 rounded-md text-md md:mt-0 bg-gray-800 active:bg-gray-900"
                href="/faq"
              >
        ...
        <div className="flex-mx-auto w-full lg:w-1/3 max-h-96 items-center mt-16 lg:-mt-24">
          <img
            className="max-w-xs lg:max-w-full lg:w-full transform lg:translate-x-20 rotate-3  flex mx-auto"
            alt="Landing"
            src="https://cdn.jsdelivr.net/gh/tsmoreau/theflyingtrapeze@1858cd982e24e091b9c7deafbd3af4f3afe55629/public/landing.jpg"
          ></img>
        </div>
      </div>
    </section>
