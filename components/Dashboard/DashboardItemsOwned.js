...
export default function DashboardItemsOwned() {
  ...
  if (loadingState === "loaded" && !nfts.length)
    return (
      <h1 className="py-10 px-20 text-3xl text-gray-300">No Items Owned</h1>
    );
  return (
    <div>
                        ...
                        <div className="">
                          {!!nft.tag1 ? (
                            <span className="">
                              <button
                                id="tagButton2"
                                class="bg-white border border-opacity-80 hover:bg-gray-500 hover:text-white rounded-lg text-gray-300 font-light text-xs px-3 py-1 mr-0.5"
