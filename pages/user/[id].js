...
export default function Home() {
  ...
  if (loadingState === "loaded" && !nfts.length)
    return (
      <div>
        <Nav />
        <div className="mt-28 flex flex-col justify-between items-center">
          <p className=" w-2/3 md:w-1/2 lg:w-1/5  truncate sm:text-6xl text-5xl items-center font-bold Avenir tracking-tight text-gray-900">
            {router.query.id}
          </p>
          ...
          <div className="mt-20 mb-10 text-xl text-gray-500">No Items</div>
        </div>
        <Footer />
      </div>
    );
    ...
    <div className="flex flex-col justify-between">
      ...
      <div className="mt-28 flex flex-col justify-between items-center">
        ...
        <div className="flex mx-auto">
          <div className="max-w-6xl p-4 flex mx-auto">
