...
export default function Home() {
  ...
  const BuyButton = ({ triedToEagerConnect }) => {
    ...
    async function buyNft(nft) {
      ...
      const transaction = await contract.createMarketPurchase(
        nftaddress,
        nft.tokenId,
        {
          value: price
    ...
    <div>
      ...
      {nfts.map((nft, i) => (
        <div className=" max-w-6xl mx-auto flex px-2 md:px-5 md:pt-18 pb-4 pt-16 md:flex-row flex-col">
          ...
          <ul>
            <li className="w-full pt-6 text-5xl md:text-2xl items-center text-center md:text-left">
              {nft.name}
            </li>
            <li className="w-full pt-3 text-normal md:text-sm items-center text-center  md:text-left md:max-w-md">
              {nft.description}
            </li>
                        ...
                        {nft.onSale === true ? (
                          <span class="">
                            <Popover className="mx-auto">
                              {({ open }) => (
                                <div className="flex items-center flex-col text-gray-300">
                                  ...
                                  >
                                    ...
                                    >
                                      <div className="border bg-white rounded-md shadow-lg transform -translate-y-36 z-999">
                          ...
                          <span className="">
                            <Popover className="">
                              {({ open }) => (
                                <div className="items-center flex flex-col text-gray-300">
                                  <Popover.Button className="mt-2 bg-gray-400 w-64 text-white tracking-tight font-light py-2  rounded hover:bg-gray-600">
                                    Item Options
                                  </Popover.Button>
                                  ...
                                  >
                                    ...
                                    >
                                      <div className="border bg-white rounded-md shadow-lg transform -translate-y-28 z-999">
